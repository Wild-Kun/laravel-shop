                        ...
                        @foreach($addresses as $address)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('user_address.edit',['user_address'=>$address->id])}}" class="btn btn-primary">修改</a>
                                    {{--<form action="{{route('user_address.destroy',['user_address'=>$address->id])}}" method="post">--}}
                                    {{--    {{csrf_field()}}--}}
                                    {{--    {{method_field('DELETE')}}--}}
